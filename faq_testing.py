...
CATEGORIZED_FAQ_DATA = {
    ...
    "Community Zones & Freehold Areas": [
        ...
        {"question": "What are the Dubai Islands by Nakheel?", "answer": "Dubai Islands by Nakheel is a newly launched multi-island development off the coast of Deira. Spanning over 17 km of waterfront, it will feature residential communities, luxury resorts, marinas, golf courses, and wellness hubs. Designed for both investors and end-users, it represents the next evolution in Dubai’s man-made island living."},
        {"question": "Are the Dubai Islands freehold for international buyers?", "answer": "Yes. Selected zones within Dubai Islands by Nakheel are available on a freehold basis for non-UAE nationals, giving full ownership rights and eligibility for investor visas."},
        {"question": "What types of properties are available on Dubai Islands?", "answer": "Buyers can choose from: Waterfront apartments,Beachfront villas,Hotel-branded residences,Plots for custom-built homes.Many are located close to resorts like *RIU Hotel Dubai* and *Centara Mirage Beach Resort*, offering a lifestyle and rental potential in one."},
        {"question": "How do Dubai Islands compare to Palm Island Dubai?", "answer": "Palm Island Dubai (Palm Jumeirah) is fully developed, with ultra-luxury apartments, villas, and *palm hotels Dubai* like Atlantis and W Hotel. Dubai Islands is newer, more diverse in offerings (including wellness and eco resorts), and more accessible from old Dubai and DXB Airport."},
        {"question": "What is unique about the Dubai World Islands?", "answer": "Dubai World Islands is a collection of over 200 man-made islands shaped like the world map. Some islands are privately owned and developed as exclusive resorts or private residences. They offer unmatched privacy and investment potential, especially for boutique hospitality."},
        {"question": "Are there any beachfront townhouses or villas available on Dubai Islands?", "answer": "Absolutely. Dubai Islands by Nakheel will feature luxury beachfront townhouses and villas with direct sea views and private beach access. Early investors are expected to benefit from off-plan pricing and flexible payment plans."},
        {"question": "How close are the Dubai Islands to the airport and downtown Dubai?", "answer": "The islands are strategically located just 15 minutes from Dubai International Airport (DXB) and 20 minutes from Downtown Dubai, making them ideal for frequent travelers and holiday homeowners."},
        {"question": "Will Dubai Islands have schools, hospitals, and supermarkets?", "answer": "Yes. The master plan includes: Schools and nurseries, Medical clinics and wellness centers, Retail areas and community supermarkets, This makes the islands suitable not just for investment but for family living as well."},
        {"question": "How is Dubai Islands different from Dubai’s other man-made islands like the World Islands?", "answer": "While the World Islands are designed for private island ownership and luxury resorts, Dubai Islands offer a more community-oriented experience with a mix of residential, commercial, and recreational facilities. It focuses on offering a well-rounded lifestyle for long-term residents rather than just tourism."},
    ...
    "Off-Plan Property Questions": [
        ...
        {"question": "Are there any off-plan projects currently available on Dubai Islands?", "answer": "Yes. Several developers, including Nakheel, are launching off-plan residences on Dubai Islands with flexible payment plans and post-handover options. These include beachfront apartments, hotel-branded units, and waterfront townhouses. Early investors benefit from pre-launch pricing and high resale value at handover."},
    ...
    "Developer-Specific FAQs": [
        ...
        {"question": "What types of buyers are Dubai Islands suited for?", "answer": "Dubai Islands is an excellent choice for luxury buyers, investors, families, and even tourism-focused entrepreneurs looking to capitalize on the area’s long-term development. With its comprehensive lifestyle offerings, it suits those seeking a high-end living experience with easy access to both urban amenities and nature."},
    ...
    "Pricing & ROI": [
        ...
        {"question": "Why invest in Dubai’s man-made islands?", "answer": "hese islands are among the most sought-after real estate locations due to:Waterfront access and private beaches,Strong capital appreciation,High tourist demand = rental income potential,Master planning by top developers like NakheelVisa benefits for property owners."},
        {"question": "What is the ROI like for properties near RIU Hotel and Centara Dubai?", "answer": "Properties near *RIU Hotel Dubai* and *Centara Mirage* attract strong tourist footfall, making them ideal for short-term rentals or vacation homes. ROI can range from *6% to 10% annually*, depending on the unit type and view."},
        {"question": "What’s the entry-level price for a property on Dubai Islands?", "answer": "Prices start from approximately AED 1.2M ($325K) for 1-bedroom beachfront apartments, with villas starting around AED 4M ($1.1M). Prices are expected to rise as the islands develop."},
        {"question": "Can I get a mortgage for a property on Dubai Islands or Palm Jumeirah as a foreign buyer?", "answer": "Yes, UAE banks and lenders offer mortgages to expat and non-resident buyers.,Loan-to-value (LTV) up to 50–70% for non-residents,Tenure up to 25 years, Pre-approval typically required before signing the SPA, Work with a trusted mortgage broker to speed up the process."},
 ],
    "Visa, Tax & Inheritance": [
        ...
        {"question": "Can I get residency if I buy property on Dubai Islands?", "answer": "Yes. Foreign investors purchasing property over AED 750,000 are eligible for a 2-year residency visa, and those investing AED 2M+ may qualify for the Golden Visa (10 years)."},
    ],
    "Rental & Property Management": [
        ...
        {"question": "Can I rent out my property in Dubai Islands on short-term platforms like Airbnb?", "answer": "Yes, most zones on Dubai Islands will allow short-term leasing, making them perfect for Airbnb and vacation rental income. Proximity to resorts like Centara Dubai increases occupancy potential year-round."},
        ...
        {"question": "What’s the best location for long-term rental demand — Dubai Islands or Palm Jumeirah?", "answer": "Palm Jumeirah is better for high-end, short-term luxury rentals, often preferred by tourists.Dubai Islands is expected to attract long-term residents due to its affordability, accessibility to old Dubai, and upcoming infrastructure (schools, hospitals, malls).If you're planning for stable annual rental income, Dubai Islands may offer lower vacancy and more consistent yields."},
    ...
    "Property Buying Process": [
        ...
        {"question": "How do I buy property on Dubai Islands or Palm Jumeirah?", "answer": "Contact our licensed real estate team for: Up-to-date listings, Payment plan options (10%-20% down payment), Full guidance on ownership, title deeds, and legal process."},
